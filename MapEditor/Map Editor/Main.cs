...
namespace Map_Editor
{
    public partial class Main : Form
    {
        ...
        public void createLargeMap()
        {
            ...
            string SimpleFileName = Path.GetDirectoryName(mapFileName) + @"\" + Path.GetFileNameWithoutExtension(mapFileName);
            //MessageBox.Show(SimpleFileName);
            miniBitmap.Save(SimpleFileName + "_XLargeMap.png", ImageFormat.Png);
            MessageBox.Show("Saved... " + SimpleFileName + "_XLargeMap.png");
        ...
        public void createXLargeMap()
        {
            ...
            string SimpleFileName = Path.GetDirectoryName(mapFileName) + @"\" + Path.GetFileNameWithoutExtension(mapFileName);
            //MessageBox.Show(SimpleFileName);
            miniBitmap.Save(SimpleFileName + "_XXLargeMap.png", ImageFormat.Png);
            MessageBox.Show("Saved... " + SimpleFileName + "_XXLargeMap.png");
