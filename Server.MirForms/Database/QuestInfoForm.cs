...
namespace Server
{
    public partial class QuestInfoForm : Form
    {
        ...
        {
            UpdateInterface();
            UpdateQScriptDisplay();
        }

        private void UpdateQScriptDisplay()
        {
            string basePath = "Envir\\Quests";
            string fileName = QFileNameTextBox.Text;
            ...
            try
            {
                ...
                QuestScriptTextBox.Text = fileContent;
                QuestScriptTextBox.ReadOnly = !isEditing;
            }
            catch (Exception ex)
            {
                return;
        ...
        {
            string basePath = "Envir\\Quests"; // Adjust as needed
            ...
            try
            {
                ...
                File.WriteAllText(filePath, QuestScriptTextBox.Text);
            }
            catch (Exception ex)
            {
        ...
        private void EditQScriptBtn_Click(object sender, EventArgs e)
        {
            isEditing = !isEditing;
            QuestScriptTextBox.ReadOnly = !isEditing;
        ...
        private void OpenQScriptBtn_Click(object sender, EventArgs e)
        {
            if (QFileNameTextBox.Text == string.Empty) return;
            ...
            else
            {
                ...
                string templateFilePath = "Envir\\Quests\\Template.txt";
        ...
        private void CopyQScriptBtn_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                // Set initial directory and suggested file name
                saveFileDialog.InitialDirectory = "Envir\\Quests"; // Adjust as needed
                saveFileDialog.FileName = QFileNameTextBox.Text;
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        File.WriteAllText(saveFileDialog.FileName, QuestScriptTextBox.Text);
