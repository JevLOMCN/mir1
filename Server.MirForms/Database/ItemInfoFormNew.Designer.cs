...
namespace Server.Database
{
    partial class ItemInfoFormNew
    {
        ...
        private void InitializeComponent()
        {
            ...
            itemInfoGridView.Columns.AddRange(new DataGridViewColumn[] { Modified, ItemIndex, ItemName, ItemType, ItemGrade, ItemRequiredType, ItemRequiredGender, ItemRequiredClass, ItemSet, ItemRandomStatsId, ItemRequiredAmount, ItemImage, ItemShape, ItemEffect, ItemStackSize, ItemWeight, ItemLightRange, ItemLightIntensity, ItemDurability, ItemPrice, ItemToolTip, StartItem, NeedIdentify, ShowGroupPickup, GlobalDropNotify, ClassBased, LevelBased });
        ...
        private DataGridViewComboBoxColumn ItemGrade;
        private DataGridViewComboBoxColumn ItemRequiredType;
        private DataGridViewComboBoxColumn ItemRequiredGender;
        private DataGridViewComboBoxColumn ItemRequiredClass;
        private DataGridViewComboBoxColumn ItemSet;
        private DataGridViewTextBoxColumn ItemRandomStatsId;
        private DataGridViewTextBoxColumn ItemRequiredAmount;
        private DataGridViewTextBoxColumn ItemImage;
        private DataGridViewTextBoxColumn ItemShape;
        private DataGridViewTextBoxColumn ItemEffect;
        private DataGridViewTextBoxColumn ItemStackSize;
        private DataGridViewTextBoxColumn ItemWeight;
        private DataGridViewTextBoxColumn ItemLightRange;
        private DataGridViewTextBoxColumn ItemLightIntensity;
        private DataGridViewTextBoxColumn ItemDurability;
        private DataGridViewTextBoxColumn ItemPrice;
        private DataGridViewTextBoxColumn ItemToolTip;
        private DataGridViewCheckBoxColumn StartItem;
        private DataGridViewCheckBoxColumn NeedIdentify;
        private DataGridViewCheckBoxColumn ShowGroupPickup;
        private DataGridViewCheckBoxColumn GlobalDropNotify;
        private DataGridViewCheckBoxColumn ClassBased;
        private DataGridViewCheckBoxColumn LevelBased;
    }
}