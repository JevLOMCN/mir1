...
namespace Server
{
    public partial class SMain : Form
    {
        ...
        private ListViewItem CreateListView(CharacterInfo character)
        {
            ...
            ListItem.SubItems.Add(character.Player.CurrentMap.Info.Title.ToString());
        ...
        private void reloadNPCsToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Envir.ReloadNPCs();
        }

        private void reloadDropsToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Envir.ReloadDrops();
        }
        ...
        private void GuildListView_DoubleClick(object sender, EventArgs e)
        {
            ...
            GuildMembersForm form = new GuildMembersForm
            {
            ...
            foreach (var r in Guild.Ranks)
                foreach (var m in r.Members)
                {
                    ...
                    form.GuildMembersListView.Items.Add(tempItem);
                }
