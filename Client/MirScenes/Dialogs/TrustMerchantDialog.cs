...
namespace Client.MirScenes.Dialogs
{
    public sealed class TrustMerchantDialog : MirImageControl
    {
                ...
                else
                {
                    switch (Selected.Listing.ItemType)
                    {
                        ...
                        case MarketItemType.Auction:
                            {
                                MirAmountBox bidAmount = new MirAmountBox("Bid Amount:", Selected.Listing.Item.Info.Image, Libraries.Items, uint.MaxValue, Selected.Listing.Price + 1, Selected.Listing.Price + 1);
        ...
        private void SetupFilters()
        {
            ...
            crafting.SubFilters.Add(new Filter { Index = 701, Title = "Materials", Type = ItemType.Material });
