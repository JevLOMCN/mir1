...
{
    public class ItemMonster : MonsterObject
    {
        protected override bool CanAttack { get { return false; } }
        protected override bool CanRegen { get { return false; } }
        protected internal ItemMonster(MonsterInfo info)
            : base(info)
        {
        ...
        public override void ChangeHP(int amount)
        {
            ...
            if (HP < Stats[Stat.HP] / 2 && Direction == MirDirection.Up)
            {
                Turn(MirDirection.UpRight);
                Drop();
            }
        }
    }
